...
void OLED_WR_Byte(uint8_t dat,uint8_t mode)
{
    ...
    gTxCount = DL_I2C_fillControllerTXFIFO(I2C1, &gTxPacket[0], gTxLen);
    ...
    DL_I2C_startControllerTransfer(I2C1, 0x3C, DL_I2C_CONTROLLER_DIRECTION_TX, gTxLen);
    ...
    switch (DL_I2C_getPendingInterrupt(I2C1)) {
        ...
        case DL_I2C_IIDX_CONTROLLER_TX_DONE:
            DL_I2C_disableInterrupt(
                I2C1, DL_I2C_INTERRUPT_CONTROLLER_TXFIFO_TRIGGER);
        ...
        case DL_I2C_IIDX_CONTROLLER_TXFIFO_TRIGGER:
            ...
            if (gTxCount < gTxLen) {
                gTxCount += DL_I2C_fillControllerTXFIFO(
                    I2C1, &gTxPacket[gTxCount], gTxLen - gTxCount);
            }
            break;
